## Presentation
Hello i'm BreadEater, a 15-year-old self-taught fullstack developer that love coding for fun and not for profits, the only thing missing for me to be good is patience, im not patient at all atleast for irl stuff.
...
- HTML/CSS/JS
- JavaScript (server side using NodeJS)
- TypeScript
- PHP
- SQL
- Shell scripts (for linux and windows)
- JSON (obviously)
...
## My projects
I do projects but the majority of the time i stop working on them due to losing motivation, the only public project i work on is a minecraft server i host and develop for someone.
